{
  ...
  '#':: d.pkg(name='system', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    '#withDomain':: d.fn(help='"An entity reference to the domain that the system belongs to."', args=[d.arg(name='domain', type=d.T.string)]),
