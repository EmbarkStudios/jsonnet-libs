{
  ...
  '#':: d.pkg(name='resource', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    '#withDependsOn':: d.fn(help='"An array of references to other entities that the resource depends on to function."', args=[d.arg(name='dependsOn', type=d.T.array)]),
    withDependsOn(dependsOn): { spec+: { dependsOn: if std.isArray(v=dependsOn) then dependsOn else [dependsOn] } },
    '#withDependsOnMixin':: d.fn(help='"An array of references to other entities that the resource depends on to function."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dependsOn', type=d.T.array)]),
    withDependsOnMixin(dependsOn): { spec+: { dependsOn+: if std.isArray(v=dependsOn) then dependsOn else [dependsOn] } },
    '#withOwner':: d.fn(help='"An entity reference to the owner of the resource."', args=[d.arg(name='owner', type=d.T.string)]),
    withOwner(owner): { spec+: { owner: owner } },
    '#withSystem':: d.fn(help='"An entity reference to the system that the resource belongs to."', args=[d.arg(name='system', type=d.T.string)]),
    withSystem(system): { spec+: { system: system } },
    '#withType':: d.fn(help='"The type of resource."', args=[d.arg(name='type', type=d.T.string)]),
