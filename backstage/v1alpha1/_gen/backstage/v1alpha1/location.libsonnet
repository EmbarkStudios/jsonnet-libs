{
  ...
  '#':: d.pkg(name='location', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    '#withPresence':: d.fn(help='"Whether the presence of the location target is required and it should be considered an error if it can not be found"', args=[d.arg(name='presence', type=d.T.string)]),
    withPresence(presence): { spec+: { presence: presence } },
    '#withTarget':: d.fn(help='"A single target as a string. Can be either an absolute path/URL (depending on the type), or a relative path such as ./details/catalog-info.yaml which is resolved relative to the location of this Location entity itself."', args=[d.arg(name='target', type=d.T.string)]),
    withTarget(target): { spec+: { target: target } },
    '#withTargets':: d.fn(help='"A list of targets as strings. They can all be either absolute paths/URLs (depending on the type), or relative paths such as ./details/catalog-info.yaml which are resolved relative to the location of this Location entity itself."', args=[d.arg(name='targets', type=d.T.array)]),
    withTargets(targets): { spec+: { targets: if std.isArray(v=targets) then targets else [targets] } },
    '#withTargetsMixin':: d.fn(help='"A list of targets as strings. They can all be either absolute paths/URLs (depending on the type), or relative paths such as ./details/catalog-info.yaml which are resolved relative to the location of this Location entity itself."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targets', type=d.T.array)]),
    withTargetsMixin(targets): { spec+: { targets+: if std.isArray(v=targets) then targets else [targets] } },
    '#withType':: d.fn(help="\"The single location type, that's common to the targets specified in the spec. If it is left out, it is inherited from the location type that originally read the entity data.\"", args=[d.arg(name='type', type=d.T.string)]),
