{
  ...
  '#':: d.pkg(name='component', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    '#withConsumesApis':: d.fn(help='"An array of entity references to the APIs that are consumed by the component."', args=[d.arg(name='consumesApis', type=d.T.array)]),
    withConsumesApis(consumesApis): { spec+: { consumesApis: if std.isArray(v=consumesApis) then consumesApis else [consumesApis] } },
    '#withConsumesApisMixin':: d.fn(help='"An array of entity references to the APIs that are consumed by the component."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='consumesApis', type=d.T.array)]),
    withConsumesApisMixin(consumesApis): { spec+: { consumesApis+: if std.isArray(v=consumesApis) then consumesApis else [consumesApis] } },
    '#withDependsOn':: d.fn(help='"An array of references to other entities that the component depends on to function."', args=[d.arg(name='dependsOn', type=d.T.array)]),
    withDependsOn(dependsOn): { spec+: { dependsOn: if std.isArray(v=dependsOn) then dependsOn else [dependsOn] } },
    '#withDependsOnMixin':: d.fn(help='"An array of references to other entities that the component depends on to function."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dependsOn', type=d.T.array)]),
    withDependsOnMixin(dependsOn): { spec+: { dependsOn+: if std.isArray(v=dependsOn) then dependsOn else [dependsOn] } },
    '#withLifecycle':: d.fn(help='"The lifecycle state of the component."', args=[d.arg(name='lifecycle', type=d.T.string)]),
    withLifecycle(lifecycle): { spec+: { lifecycle: lifecycle } },
    '#withOwner':: d.fn(help='"An entity reference to the owner of the component."', args=[d.arg(name='owner', type=d.T.string)]),
    withOwner(owner): { spec+: { owner: owner } },
    '#withProvidesApis':: d.fn(help='"An array of entity references to the APIs that are provided by the component."', args=[d.arg(name='providesApis', type=d.T.array)]),
    withProvidesApis(providesApis): { spec+: { providesApis: if std.isArray(v=providesApis) then providesApis else [providesApis] } },
    '#withProvidesApisMixin':: d.fn(help='"An array of entity references to the APIs that are provided by the component."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='providesApis', type=d.T.array)]),
    withProvidesApisMixin(providesApis): { spec+: { providesApis+: if std.isArray(v=providesApis) then providesApis else [providesApis] } },
    '#withSubcomponentOf':: d.fn(help='"An entity reference to another component of which the component is a part."', args=[d.arg(name='subcomponentOf', type=d.T.string)]),
    withSubcomponentOf(subcomponentOf): { spec+: { subcomponentOf: subcomponentOf } },
    '#withSystem':: d.fn(help='"An entity reference to the system that the component belongs to."', args=[d.arg(name='system', type=d.T.string)]),
    withSystem(system): { spec+: { system: system } },
    '#withType':: d.fn(help='"The type of component."', args=[d.arg(name='type', type=d.T.string)]),
