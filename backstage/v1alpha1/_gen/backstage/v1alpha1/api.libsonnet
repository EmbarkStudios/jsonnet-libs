{
  ...
  '#':: d.pkg(name='api', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    '#withDefinition':: d.fn(help='"The definition of the API, based on the format defined by the type."', args=[d.arg(name='definition', type=d.T.string)]),
    withDefinition(definition): { spec+: { definition: definition } },
    '#withLifecycle':: d.fn(help='"The lifecycle state of the API."', args=[d.arg(name='lifecycle', type=d.T.string)]),
    withLifecycle(lifecycle): { spec+: { lifecycle: lifecycle } },
    '#withOwner':: d.fn(help='"An entity reference to the owner of the API."', args=[d.arg(name='owner', type=d.T.string)]),
    withOwner(owner): { spec+: { owner: owner } },
    '#withSystem':: d.fn(help='"An entity reference to the system that the API belongs to."', args=[d.arg(name='system', type=d.T.string)]),
    withSystem(system): { spec+: { system: system } },
    '#withType':: d.fn(help='"The type of the API definition."', args=[d.arg(name='type', type=d.T.string)]),
