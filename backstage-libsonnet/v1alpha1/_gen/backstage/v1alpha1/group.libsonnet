{
  ...
  '#':: d.pkg(name='group', url='', help="\"The parts of the format that's common to all versions/kinds of entity.\""),
  ...
  spec: {
    ...
    profile: {
      ...
      '#withEmail':: d.fn(help='"An email where this entity can be reached."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { profile+: { email: email } } },
      '#withPicture':: d.fn(help='"The URL of an image that represents this entity."', args=[d.arg(name='picture', type=d.T.string)]),
      withPicture(picture): { spec+: { profile+: { picture: picture } } },
    },
    '#withChildren':: d.fn(help='"The immediate child groups of this group in the hierarchy (whose parent field points to this group). The list must be present, but may be empty if there are no child groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references."', args=[d.arg(name='children', type=d.T.array)]),
    withChildren(children): { spec+: { children: if std.isArray(v=children) then children else [children] } },
    '#withChildrenMixin':: d.fn(help='"The immediate child groups of this group in the hierarchy (whose parent field points to this group). The list must be present, but may be empty if there are no child groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='children', type=d.T.array)]),
    withChildrenMixin(children): { spec+: { children+: if std.isArray(v=children) then children else [children] } },
    '#withMembers':: d.fn(help='"The users that are members of this group. The entries of this array are entity references."', args=[d.arg(name='members', type=d.T.array)]),
    withMembers(members): { spec+: { members: if std.isArray(v=members) then members else [members] } },
    '#withMembersMixin':: d.fn(help='"The users that are members of this group. The entries of this array are entity references."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='members', type=d.T.array)]),
    withMembersMixin(members): { spec+: { members+: if std.isArray(v=members) then members else [members] } },
    '#withParent':: d.fn(help='"The immediate parent group in the hierarchy, if any. Not all groups must have a parent; the catalog supports multi-root hierarchies. Groups may however not have more than one parent. This field is an entity reference."', args=[d.arg(name='parent', type=d.T.string)]),
    withParent(parent): { spec+: { parent: parent } },
    '#withType':: d.fn(help='"The type of group. There is currently no enforced set of values for this field, so it is left up to the adopting organization to choose a nomenclature that matches their org hierarchy."', args=[d.arg(name='type', type=d.T.string)]),
